                ...
                <table class="table tabla">
                    ...
                    @foreach($usuarios as $u)
                        <tr>
                            ...
                            <td>{{$u->correo}}</td>
                            <td>{{$u->contrasena}}</td>
                            @if($u->id_tipo_persona === 1)
                            <td>
                                Administrador máster
                            </td>
                            @elseif($u->id_tipo_persona === 2)
                            <td>
                                Administrador
                            </td>
                            @elseif($u->id_tipo_persona === 3)
                            <td>
                                Vendedor
                            </td>
                            @elseif($u->id_tipo_persona === 4)
                            <td>
                                Cliente
                            </td>
                            @endif
                            ...
                            <td>
                                <div class="d-flex flex-row">
                                    <div class="d-flex ml-n2 mr-1">
                                        <a href="#" data-toggle="modal" data-target="#modificarUsuario{{$u->id_persona}}">
                        ...
                        @include('modales/modificarUsuario')
                    @endforeach
                    </tbody>
                </table>
            </div>
